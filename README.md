...
* [Microsoft Edge Add-ons](https://microsoftedge.microsoft.com) - As a Microsoft Edge extension developer, you use Partner Center to publish an extension at the Microsoft Edge Add-ons website, to make the extension available to Microsoft Edge users.
...
* Communicating with the Extensions team:
  * Report bugs or issues about the Microsoft Edge Add-ons website that affect all Edge extension developers or all Microsoft Edge extension users.
...
* Discussions with the Extensions team:
  ...
  * Discuss improving the UI of the Microsoft Edge Add-ons website.
