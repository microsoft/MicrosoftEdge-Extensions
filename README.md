...
* The [Microsoft Edge Add-ons](https://microsoftedge.microsoft.com) store - As a Microsoft Edge extension developer, you use Partner Center to publish an extension at the Microsoft Edge Add-ons store, to make the extension available to Microsoft Edge users.
